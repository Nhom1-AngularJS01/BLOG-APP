app.controller('controller', function ($state, $rootScope, $window) {
    // $rootScope.user = JSON.parse('{"user":{"id":42762,"email":"diunguyen.nttd@gmail.com","createdAt":"2018-11-21T04:14:44.637Z","updatedAt":"2018-11-22T02:30:25.806Z","username":"diunguyen","bio":null,"image":null,"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6NDI3NjIsInVzZXJuYW1lIjoiZGl1bmd1eWVuIiwiZXhwIjoxNTQ4MzgyODcyfQ.XYNUQc4I4IydyD6MpAdNU6pAiXQKLjD3iO0bJVbxaZk"}}');
...
app.controller('homeController', ['$scope', 'TagsSerive', 'PreArticalsService', '$rootScope', 'YourFeedsService', 'FavorService', '$window',function ($scope, TagsSerive, PreArticalsService, $rootScope, YourFeedsService, FavorService, $window) {
